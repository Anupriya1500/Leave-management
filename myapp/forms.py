...
#Cancellation
    #Pending
        if leave.is_leave_pending and leave.is_leave_approved and not leave.is_leave_rejected and leave.is_leave_cancelled:
            Status_Choices=[('Cancelation Approved','Cancelation Approved'),
    ('Cancelation Rejected','Cancelation Rejected'),
    
    ]
    #Updating
        if not leave.is_leave_pending and leave.is_leave_approved or  leave.is_leave_rejected and leave.is_leave_cancelled:
            Status_Choices=[('Cancelation Approved','Cancelation Approved'),
    ('Cancelation Rejected','Cancelation Rejected'),
...
# Pending Leave Request--------------------------------
        ...
        if leave.is_leave_pending and leave.is_leave_approved and not leave.is_leave_rejected and not leave.is_leave_cancelled:
            ...
            if new_status=='Approved':
                ...
                business_days_count=np.busday_count(leave.from_date.strftime('%Y-%m-%d'),leave.to_date.strftime('%Y-%m-%d'))
...
# Updating Approved or Rejected-------------------------
        # 0 0 1 0    
        if not leave.is_leave_pending and not leave.is_leave_approved and leave.is_leave_rejected and not leave.is_leave_cancelled:
            ...
            if new_status=='Rejected':
                pass
        # 0 1 0 0
        if not leave.is_leave_pending and leave.is_leave_approved and not leave.is_leave_rejected and not leave.is_leave_cancelled:
...
# Cancellation--------------------------
    ...
    # Updating  
        # 0 1 0 1
        if not leave.is_leave_pending and leave.is_leave_approved and not leave.is_leave_rejected and leave.is_leave_cancelled:
