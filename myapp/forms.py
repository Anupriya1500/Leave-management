...
def date_diff(leave):
        if leave.include_sat_sun:
            business_days_count=np.busday_count(leave.from_date.strftime('%Y-%m-%d'),leave.to_date.strftime('%Y-%m-%d'),weekmask='1111111')
        else:
            business_days_count=np.busday_count(leave.from_date.strftime('%Y-%m-%d'),leave.to_date.strftime('%Y-%m-%d'),weekmask='1111100')
